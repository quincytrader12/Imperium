...
#: that can be overridden -- see godalgo.server.app.validate_bind_host, which
...
def home_dir() -> Path:
    """Return the configuration directory, honouring GODALGO_HOME for tests."""
    override = os.environ.get("GODALGO_HOME")
    if override:
